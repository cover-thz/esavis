...
extern double get_min_double(double *dbl_arr, int arr_len);


extern int get_weighted_sum_limits(double *power_arr, int arr_len, 
    int *start_ind, int *stop_ind);


extern double calc_noise_floor(double *rangeline_power, int num_noise_pts, 
                        double noise_start_frac, int rng_len);
                          

extern int extract_aux_data(double *rangeline_power, int rng_len,
...
extern int extract_single_rangeline_peaks(double *rangeline_power, int rng_len, 
    double *range_lut_cm, double threshold_lin, 
    double contrast_lin, int half_peak_width, double min_range, 
    double max_range, int num_noise_pts, double noise_start_frac, 
    int *interm_peak_inds, bool calc_weighted_sum, double *peak_ranges, 
...
extern int extract_all_rangeline_peaks(double *power_array, bool *valid_array, 
